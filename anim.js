...
var lyricsData = [
  ...
  { text: "Tengo tanto tanto muy dentro mio", time: 25 },
  { text: "Tantos latidos, tantas miradas llenan de amor al vacio", time: 31 },
  { text: "Tantos latidos, tantas miradas llenan de amor al vacio", time: 33 },
  { text: "Pero el tiempo se hace corto cada vez", time: 38 },
  { text: "En la espera no se si es que habra un despues", time: 44 },
  ...
  { text: "Tantos anhelos, tantos consuelos mas que un poema", time: 102 },
  { text: "Tantos anhelos, tantos consuelos mas que un poema", time: 104 },
  { text: "Pero tienes que marcharte ya lo se", time: 110 },
  { text: "Aunque se que pronto volvere a verte", time: 115 },
  ...
  { text: "Hoy eres mío y de nadie mas amor", time: 153 },
  { text: "Hoy eres mío y de nadie mas amor", time: 156 },
  { text: "Hoy tengo frío y tu me das calor", time: 163 },
  ...
  { text: "Feliz (atrasado) Dia de la Novia, amor. Gracias por este año con dos meses a tu lado.", time: 205 },
  { text: "Feliz (atrasado) Dia de la Novia, amor. Gracias por este año con dos meses a tu lado.", time: 208 },
  { text: "Te amo muchisimo y deseo que sigamos caminando juntos, aprendiendo y creciendo dia a dia. ❤️", time: 210},
  { text: "Te amo muchisimo y deseo que sigamos caminando juntos, aprendiendo y creciendo dia a dia. ❤️", time: 212},
];
